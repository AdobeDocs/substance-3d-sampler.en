...
>[!NOTE]
>
> If you've used the [Embroidery ](embroidery.md)filter before, the Weave filter works in a similar way. They produce different effects, but you can use images with them in the same way.
> 
