...
Learn more about it [here](../../pipeline-and-integrations/tajima-exporter-plugin.md).
...
>[!NOTE]
>
> If you've used the [Weave ](weave.md)filter before, the Embroidery filter works in a similar way.
