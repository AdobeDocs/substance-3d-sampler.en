...
You can override the location that Sampler checks for the **license.key** file with an [Environment Variable](../pipeline-and-integrations/environment-variables.md).
