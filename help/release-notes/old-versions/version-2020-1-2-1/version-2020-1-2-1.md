...
* **Update Checker configuration**   
  Define if you want to be notified if a new version is available. For more information see the dedicated [documentation page](../../../technical-support/configuration/update-checker/update-checker.md).
