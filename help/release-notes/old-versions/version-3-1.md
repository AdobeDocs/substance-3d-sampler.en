...
This release adds a new [Color Picker](../../interface/tools-and-widgets/color-picker.md) that includes an eyedropper and support for swatches.
...
Edit your Preferences to set the [normal format](../../interface/preferences/normal-format.md) you need for your workflow. Your normals will be imported, displayed and exported in the format you select in preferences.
