...
breadcrumb-title: ""
description: Review release notes for Substance 3D Sampler version 2020.1 (2.1) to learn about export presets for Unity, Unreal Engine, and other renderers.
...
* **Create, import and manage custom export presets**  
  ...
  * [Managing Presets](../../getting-started/export/managing-presets.md)
...
* **Update Checker configuration**   
  Define if you want to be notified if a new version is available. For more information see the dedicated [documentation page](../../technical-support/configuration/update-checker.md).
