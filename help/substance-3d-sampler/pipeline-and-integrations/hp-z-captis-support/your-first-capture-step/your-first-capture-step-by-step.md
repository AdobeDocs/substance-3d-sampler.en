...
![click on the "plus" icon and on HP Z Captis in Sampler to launch the device](Sampler-5.0-Captis-connect-device)
...
![](Sampler-5.0-Captis-capture-step)
