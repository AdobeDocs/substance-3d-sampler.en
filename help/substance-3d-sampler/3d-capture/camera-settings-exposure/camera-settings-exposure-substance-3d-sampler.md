---
title: "Camera Settings - Exposure | Substance 3D Sampler"
...
You prefer to watch this guide as a video tutorial? You can find it [here](https://youtu.be/kR9EGW_zxlY?si=x8dN9tccofZhScKw "Exposure for 3D capture process video tutorial").
...
<b>Aperture</b> is the opening inside your lens. The larger this opening, the more light enters the camera. It’s expressed as an F-number, where a larger the number means a smaller opening.

<b>Shutter speed </b>is the time your camera will open its shutter to gather light. A longer shutter time means more light. It’s expressed in seconds, but usually as fractions, like 1/60th of a second.

<b>ISO</b> is your camera sensor sensitivity. Increasing the ISO means the sensor is more sensitive, gathering more light.
...
What we want is an <b>image as sharp as possible</b>. ISO is easiest to set: Avoid automatic ISO settings, keep it as low as possible, ideally <b>under 400, 100 is ideal</b>.
...
<b>Aperture</b> is a bit less obvious. We don’t want a large aperture (low f-number), as this could easily cause parts of our subject to go out of focus, and we want the sharpest possible image. The exact value depends per lens, so make sure to look that up, but usually it’s <b>between f8 and f16</b>.
...
Now that you know everything about exposure, learn more about [setting your camera's focus for the 3D Capture process](../camera-settings-focus-sam/camera-settings-focus-substance-3d-sampler.md).
