...
>[!NOTE]
>
> You can expose filter parameters to control the filter directly in Sampler. See how-to [here](../../../substance-3d-designer/compositing-graphs/manage-parameters/exposing-a-parameter/exposing-a-parameter.md)
