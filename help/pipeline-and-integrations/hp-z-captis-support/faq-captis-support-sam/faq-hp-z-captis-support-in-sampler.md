...
Sampler hardware specifications are availablehere.



[here](../system-requirements-use/system-requirements-to-use-hp-z-captis.md)
...
The Auto tiling filter can be used to tile automatically materials with a defined repetitive structure or small patterns, with a minimum of 3 patterns in each direction. Learn more about this filter in thededicated section of the documentation.



[dedicated section of the documentation](../../../filters/tools/auto-tiling/auto-tiling.md)
...
[https://helpx.adobe.com/substance-3d-sampler/getting-started/export.html](../../../getting-started/export/export.md)
...
During the preview, you have the possibility to choose the output type between LDR (low dynamic range) and HDR (high dynamic range).Even if LDR is chosen, the HDR maps will be captured and saved on your device.It is advised that you select the LDR, as that will make the size of the project more manageable in Sampler and in any third party app where the sbsar file will be used.
...
To change the IP address of the device you can modify the Windows fileC:\Windows\System32\drivers\etc\hosts.txtby adding an extra line:





For example you can add192.168.55.1 captis-deviceand then inSampler's settings &gt; Storage and Cache &gt; Material capture &gt; Captis addressreplace the IP withcaptis-device
...
* Resolution: 1920x1080Maximum magnification: 100%


* Maximum magnification: 100%


* Resolution: 2560x1440Maximum magnification: 125%


* Maximum magnification: 125%


* Resolution: 3840x2160Maximum magnification: 200%
